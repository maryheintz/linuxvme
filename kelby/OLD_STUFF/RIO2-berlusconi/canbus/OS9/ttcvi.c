...
int unfold[240] = {  0, 31, 46, 61, 76, 91,106,121,136,151,
   ...
   unsigned int base1 = 0xf0b00000;
   unsigned int base2 = 0x80b00000;
...
/* ----------------------------------------------------------- */
ttcvi_map()
 { adr1 = (unsigned short *) (base1 | 0x84);
   *adr1 = 0;  /* software reset the TTCvi module */
   BroadcastShortCommand(0x10);  /* initialize all TTCrx chips */
   tsleep(0x80000050);
   SendLongCommand(0,0,0x3,0xa3);  /* set the TTCrx control register */
   adr1 = (unsigned short *) (base1 | 0x80);
   *adr1 = 0x4048;  /* set the TTCrx csr1 */
   adr1 = (unsigned short *) (base1 | 0x82);
...
SendL1A()
 { unsigned short saved = GetTriggerSelect();
   ...
   adr1 = (unsigned short *) (base1 | 0x86);
   *adr1 = 0; /* sw_l1a */
...
int channel;
 { unsigned short k;
   if(channel == 0)
     { adr1 = (unsigned short *) (base1 | 0x92);
       k = *adr1;
     } 
   if(channel == 1)
     { adr1 = (unsigned short *) (base1 | 0x9a);
       k = *adr1;
     } 
   if(channel == 2)
     { adr1 = (unsigned short *) (base1 | 0xa2);
       k = *adr1;
     } 
   if(channel == 3)
     { adr1 = (unsigned short *) (base1 | 0xaa);
       k = *adr1;
     } 
   return k;
 }
...
int channel;
 { unsigned short k;
   if(channel == 0)
     { adr1 = (unsigned short *) (base1 | 0x94);
       k = *adr1;
     } 
   if(channel == 1)
     { adr1 = (unsigned short *) (base1 | 0x9c);
       k = *adr1;
     } 
   if(channel == 2)
     { adr1 = (unsigned short *) (base1 | 0xa4);
       k = *adr1;
     } 
   if(channel == 3)
     { adr1 = (unsigned short *) (base1 | 0xac);
       k = *adr1;
     } 
   return k;
 }
...
unsigned int command;
  { adr1 = (unsigned short *) (base1 | 0xc4);
...
int channel;
 { unsigned short k;
   if(channel == 0)
     { adr1 = (unsigned short *) (base1 | 0x90);
       k = *adr1;
     } 
   if(channel == 1)
     { adr1 = (unsigned short *) (base1 | 0x98);
       k = *adr1;
     } 
   if(channel == 2)
     { adr1 = (unsigned short *) (base1 | 0xa0);
       k = *adr1;
     } 
   if(channel == 3)
     { adr1 = (unsigned short *) (base1 | 0xa8);
       k = *adr1;
     } 
   return (int)k;
 }
...
int channel,command; 
  { unsigned long kl;
    kl =  (command<<23); 
    if(channel == 0)
    { adr2 = (unsigned long *) (base2 | 0xb0);
      *adr2 = kl;
    }  
    if(channel == 1)
    { adr2 = (unsigned long *) (base2 | 0xb4);
      *adr2 = kl;
    }  
    if(channel == 2)
    { adr2 = (unsigned long *) (base2 | 0xb8);
      *adr2 = kl;
    }  
    if(channel == 3)
    { adr2 = (unsigned long *) (base2 | 0xbc);
      *adr2 = kl;
    }  
  }
...
int channel;
 { if(channel == 0)
    { adr1 = (unsigned short *) (base1 | 0x96);
      *adr1 = 0; 
    }
   if(channel == 1)
    { adr1 = (unsigned short *) (base1 | 0x9e);
      *adr1 = 0; 
    }
   if(channel == 2)
    { adr1 = (unsigned short *) (base1 | 0xa6);
      *adr1 = 0; 
    }
   if(channel == 3)
    { adr1 = (unsigned short *) (base1 | 0xae);
      *adr1 = 0; 
    }
 } 
/* ----------------------------------------------------------- */
