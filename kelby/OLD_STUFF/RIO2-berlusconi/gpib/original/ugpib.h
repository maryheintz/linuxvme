/************************************************************************
 *
 * Enhanced Engineering Software Package for GPIB interfaces
 * Version 1.0
 * Copyright (c) 1990,1991 National Instruments Corporation
 * All rights reserved.
 *
 * User GPIB include file for ESP-488.
 *
 ************************************************************************/
...
extern int  ib1sta, ib1cnt, ib1err;	/* global status variables for esp488_1.o */
extern int  ib2sta, ib2cnt, ib2err;	/* global status variables for esp488_2.o */
extern int  ib3sta, ib3cnt, ib3err;	/* global status variables for esp488_3.o */
extern int  ib4sta, ib4cnt, ib4err;	/* global status variables for esp488_4.o */
