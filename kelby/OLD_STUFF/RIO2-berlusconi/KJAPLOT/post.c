...
#include <strings.h>
      ...
      { char percent='%';
        ...
        fprintf(fpost,"%c!PS-Adobe-3.0\n",percent);
        fprintf(fpost,"%c%cTitle: (KJAPLOT)\n",percent,percent);
        fprintf(fpost,"%c%cCopyright: none\n",percent,percent);
        fprintf(fpost,"%c%cCreator: (K J Anderson)\n",percent,percent);
        fprintf(fpost,"%c%cCreationDate: (while ago)\n",percent,percent);
        fprintf(fpost,"%c%cPages: 1\n",percent,percent);
        fprintf(fpost,"%c%cLanguageLevel: 1\n",percent,percent);
        fprintf(fpost,"%c%cDocumentData: Clean7Bit\n",percent,percent);
        fprintf(fpost,"%c ----------------------------%\n",percent);
        fprintf(fpost,"%c  hope this works            %\n",percent);
        fprintf(fpost,"%c ----------------------------%\n",percent);
        fprintf(fpost,"%c%cEndComments\n",percent,percent);
        fprintf(fpost,"%c%cBeginProlog\n",percent,percent);
