	 	...
	 	{ kk = count/(nsamp+3);
		  ...
		  if(kklast == 15 && ii == 0) 
		   { if(sw(7) == 0) printf(" dig crc %x\n",word);
		     if(word != 0xffffffff) printf(" dig crc ERROR %x\n",word);
		   }
