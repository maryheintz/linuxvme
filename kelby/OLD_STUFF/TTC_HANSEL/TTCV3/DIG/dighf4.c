...
#include "SLINK.h"
#include "ttcvi.h"
int fdata[549][16],ipk[49],pk[49];

int ttcadr,id,kk;
int digadr[8] = {0x1025,0x1004,0x1006,0x101c,0x101f,0x1015,0x1020,0x1021};
int dm[8] = {0,0,0,0,1,1,0,0};
...
char *envs[];
  { 
    ...
    int tim,i,l,k, kkk, pipe, drawer,dig,eid;
    int tube, card_num;
    int dac;
...
/*		printf("channel No. = ");
        	fscanf(stdin,"%d",&pipe); */
		sprintf(string,"tubes 1 -- 6 ");
  		bigdisp(14,string,1);
  		sprintf(string,"tubes 7 -- 12 ");
 	 	bigdisp(14,string,7);
		sprintf(string,"tubes 13 -- 18 ");
 	 	bigdisp(14,string,13);
		sprintf(string,"tubes 19 -- 24 ");
 	 	bigdisp(14,string,19);
		sprintf(string,"tubes 25 -- 30 ");
 	 	bigdisp(14,string,25);
		sprintf(string,"tubes 31 -- 36 ");
 	 	bigdisp(14,string,31);
		sprintf(string,"tubes 37 -- 42 ");
 	 	bigdisp(14,string,37);
		sprintf(string,"tubes 43 -- 48 ");
 	 	bigdisp(14,string,43);
...
/*	  if(mode == 1) SendLongCommand(adrttc,0,0x3,0xa8); */ /* reset ttcrx chip */
	...
	SendLongCommand(adrttc,1,0x2,58); /* set pipeline length=21 */
	usleep(200);
